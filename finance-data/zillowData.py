...
config.read(
    os.path.abspath("./zillow_db/zillowData.ini")
)  # use full filepath if automating
...
zillow_data_url = (
    f"https://data.nasdaq.com/api/v3/datatables/ZILLOW/DATA.csv?&api_key={api_key}"
)
zillow_indicators_url = f"https://data.nasdaq.com/api/v3/datatables/ZILLOW/INDICATORS.csv?&api_key={api_key}"
zillow_regions_url = (
    f"https://data.nasdaq.com/api/v3/datatables/ZILLOW/REGIONS.csv?&api_key={api_key}"
)
